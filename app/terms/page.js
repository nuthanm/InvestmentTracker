...
export const metadata = {
  ...
  description: 'Terms for using InvestmentTracker services.',
};
...
export default function TermsPage() {
  return (
    <main className="legal-wrap">
      ...
      <p>
        InvestmentTracker is a personal tracking and planning application. It does not provide brokerage,
        custody, lending, or regulated investment advisory services.
      </p>
      ...
      <p>
        You are responsible for maintaining account security and for activities performed using your account.
        Provide accurate information and avoid unauthorized usage.
      </p>
      ...
      <p>
        To the extent permitted by law, we are not liable for indirect or consequential losses related to market
