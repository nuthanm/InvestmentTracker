...
export const SCHEME_STATUS_OPTIONS = [
  { value: SCHEME_STATUSES.CLOSED, label: 'Closed / redeemed' },
  { value: SCHEME_STATUSES.ACTIVE, label: 'Active (still paying)' },
  { value: SCHEME_STATUSES.PREMATURE_WITHDRAWAL, label: 'Premature withdrawal' },
];

export function isPrematureWithdrawal(schemeStatus) {
  return schemeStatus === SCHEME_STATUSES.PREMATURE_WITHDRAWAL;
}
